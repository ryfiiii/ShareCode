    ...
    return (
        <>
                ...
                <div className="flex justify-center items-center">
                    ...
                    <div className="mx-3 dropdown dropdown-end">
                        ...
                        <ul tabIndex={0} className="mt-3 z-[1] p-2 shadow menu menu-sm dropdown-content bg-base-100 rounded-box w-52">
                            {props.auth?.user ? (
                                <>
                                    <li><Link href={route('user', { user: props.auth.user.user_id })} className="py-3">マイページ</Link></li>
            ...
            {/* <div className="btm-nav lg:hidden">
                ...
                <Link href={route('user', { user: props.auth.user?.user_id })} as="button" type="button" className={route().current('user') ? 'active' : ''}>
